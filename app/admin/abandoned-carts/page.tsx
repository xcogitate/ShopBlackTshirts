  ...
  const loadCarts = useMemo(
    () => async () => {
      ...
      try {
        ...
        toast({ title: "Load failed", description: "Could not load abandoned carts.", variant: "destructive" })
      } finally {
        setLoading(false)
      }
    },
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-400">
            Monitor carts marked abandoned, reminder progress, and opt-outs.
          </p>
        </div>
                    ...
                    <TableRow key={cart.id} className="border-white/10">
                      ...
                      <TableCell className="text-sm text-gray-200">
                        ...
                        <div className="text-xs text-gray-500">
                          Next: {formatDateTime(cart.nextReminderAt)}
                        </div>
                      </TableCell>
                      <TableCell className="text-sm text-gray-200">
                        {cart.email ?? "—"}
